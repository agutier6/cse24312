...
// There are 234 URLs in the Notre Dame CSE Page Sitemap
// There are 105 URLs in the nd.edu sitemap
// There are 18,788 URLs URLs in the und.com sitemap 
// There are a total of 19,127 URLs 
// Percentage is 96.75% => 1 - 0.9675 = 0.0625
// k = −log2(0.0625) = 4  => 4 Hash Functions
// m = (4)*(19,127) / ln(2) = 110,377.71 
...
/********************************************
* Function Name  : getBloomVals
* Pre-conditions :  std::string& urlIn, std::bitset< primeURLs >& bitHash 
* Post-conditions: none
*  
********************************************/
void getBloomVals( std::string& urlIn, std::bitset< primeURLs >& bitHash ){
...
/********************************************
* Function Name  : checkHashVals
* Pre-conditions : std::string& urlIn, std::bitset< bitsetsize >& bitHash
* Post-conditions: bool
*  
* Checks the URL against the Bloom Filter to see if the value is probably 
...
/********************************************
* Function Name  : checkURLAccesses
* Pre-conditions : std::ifstream& urlFile, std::bitset< bitsetsize >& bitHash
* Post-conditions: none
*  
********************************************/
